...
${document2}`;
  ...
  // temple-document-server-resolver:C:\Users\rheil\Desktop\task\temple\packages\temple-web\src\pages\index.dtml
  var pages_exports = {};
  __export(pages_exports, {
    default: () => Index_2680246292da685271ac
  });
  ...
  // temple-document-server-resolver:C:\Users\rheil\Desktop\task\temple\packages\temple-web\src\pages\index.dtml
  var Index_2680246292da685271ac = class extends import_server.TempleDocument {
    id() {
      return "2680246292da685271ac";
    }
    styles() {
      return `@temple theme;
  @temple reset;
...
`, false)
      ...
      `, false),
        ...
        `, false)
                ...
                import_server.TempleRegistry.createText(`
        `, false),
                import_server.TempleRegistry.createElement("section", { "class": `m-auto py-40 px-20 tx-center flex flex-row flex-center gap-50` }, "{ 'class': `m-auto py-40 px-20 tx-center flex flex-row flex-center gap-50` }", [
                  import_server.TempleRegistry.createText(`
        ...
        `, false),
                  import_server.TempleRegistry.createElement("div", {}, "{ }", [
                    import_server.TempleRegistry.createText(`
          `, false),
                    import_server.TempleRegistry.createElement("h1", { "class": `tx-26 mb-20` }, "{ 'class': `tx-26 mb-20` }", [
                      import_server.TempleRegistry.createText(`Contact Us!`, false)
                    ]),
                    import_server.TempleRegistry.createText(`
          `, false),
                    import_server.TempleRegistry.createElement("div", { "class": `flex flex-center flex-col gap-10` }, "{ 'class': `flex flex-center flex-col gap-10` }", [
                      import_server.TempleRegistry.createText(`
            `, false),
                      import_server.TempleRegistry.createElement("input-box", { "type": `email`, "placeholder": `Email` }, "{ 'type': `email`, 'placeholder': `Email` }", []),
                      import_server.TempleRegistry.createText(`
            `, false),
                      import_server.TempleRegistry.createElement("input-box", { "type": `text`, "placeholder": `Subject` }, "{ 'type': `text`, 'placeholder': `Subject` }", []),
                      import_server.TempleRegistry.createText(`

            `, false),
                      import_server.TempleRegistry.createElement("textarea", { "class": `pl-10 pt-10 outline-none b-transparent curved`, "placeholder": `Message`, "cols": `30`, "row": `5`, "style": `resize: none; width: 256px;` }, "{ 'class': `pl-10 pt-10 outline-none b-transparent curved`, 'placeholder': `Message`, 'cols': `30`, 'row': `5`, 'style': `resize: none; width: 256px;` }"),
                      import_server.TempleRegistry.createText(`

          <!-- Button usign light and shadow template -->
          `, false),
                      import_server.TempleRegistry.createElement("button-box", { "name": `Submit` }, "{ 'name': `Submit` }", []),
                      import_server.TempleRegistry.createText(`
          `, false)
                    ]),
                    import_server.TempleRegistry.createText(`
