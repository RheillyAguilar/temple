var TempleAPI = (() => {
  ...
  // temple-document-client-resolver:C:\Users\rheil\Desktop\task\temple\packages\temple-web\src\pages\docs\index.dtml
  var docs_exports = {};
...
`, false),
  ...
  var Icon_39232c264eb9a88ed555 = class extends import_TempleComponent2.default {
    static component = ["icon", "Icon_39232c264eb9a88ed555"];
    styles() {
      return ``;
    }
    template() {
      ...
      return () => [
        import_TempleRegistry2.default.createElement("link", { "rel": `stylesheet`, "type": `text/css`, "href": `https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.6.0/css/all.min.css` }).element,
        import_TempleRegistry2.default.createText(`
`, false),
        import_TempleRegistry2.default.createElement("i", { "class": iconClass.join(" ") }, []).element
      ];
    }
  };

  // temple-component-resolver:C:\Users\rheil\Desktop\task\temple\packages\temple-web\src\components\api\docs.tml
  ...
  var Docs_9f0034427a9b6b0642bd = class extends import_TempleComponent3.default {
    static component = ["docs", "Docs_9f0034427a9b6b0642bd"];
    styles() {
      return ``;
    }
    template() {
...
`, false),
        import_TempleRegistry3.default.createElement("article", { "class": `block p-10 tx-t-1` }, [
  ...
  var App_efe2ceb6ea60eb88a711 = class extends import_TempleComponent4.default {
...
`, false),
        import_TempleRegistry4.default.createElement("div", { "class": `curved scroll-hidden shadow-0-0-10-0-0-0-5` }, [
          import_TempleRegistry4.default.createText(`
  `, false),
          import_TempleRegistry4.default.createElement("div", { "class": `relative flex flex-center-y gap-10 p-10 bg-t-1 tx-c-999999 tx-16` }, [
            import_TempleRegistry4.default.createText(`
    `, false),
            import_TempleRegistry4.default.createElement("span", { "class": `bg-h-999999 pill h-10 w-10` }, []).element,
            import_TempleRegistry4.default.createText(`
    `, false),
            import_TempleRegistry4.default.createElement("span", { "class": `bg-h-999999 pill h-10 w-10` }, []).element,
            import_TempleRegistry4.default.createText(`
    `, false),
            ...
            import_TempleRegistry4.default.createText(`
    `, false),
            import_TempleRegistry4.default.createElement("span", { "class": `flex flex-center h-full w-full absolute top-0 left-0` }, [
              import_TempleRegistry4.default.createText(`
      `, false),
  ...
  `, false)
          ...
          import_TempleRegistry4.default.createText(`
  `, false),
          import_TempleRegistry4.default.createElement("div", { "class": `bg-black tx-t-1 relative`, "style": style }, [
...
`, false)
  ...
  var Code_35c89122150298604c5c = class extends import_TempleComponent5.default {
...
`, false)
  ...
  var Preview_7cc0df9f260d8641884d = class extends import_TempleComponent6.default {
    static component = ["preview", "Preview_7cc0df9f260d8641884d"];
    styles() {
      return ``;
    }
    template() {
      (0, import_temple4.classlist)().add("block", "w-full", "h-full", "scroll-auto");
      return () => [
        import_TempleRegistry6.default.createText(`
`, false),
        import_TempleRegistry6.default.createElement("div", { "class": `bg-white tx-black arial p-10 h-full` }, [
  ...
  // temple-component-resolver:C:\Users\rheil\Desktop\task\temple\packages\temple-web\src\components\i18n\translate.tml
  var Translate_1ca59bea621b651fbfe8 = class extends import_TempleComponent7.default {
  ...
  import_TempleEmitter.default.once("ready", () => {
    ...
    const __BINDINGS__ = { "2": { "class": `flex flex-center-y px-20 py-15 m-0 bg-t-1` }, "3": { "class": `fas fa-fw fa-bars cursor-pointer py-5 pr-10 none md-inline-block tx-t-1`, "click": toggle }, "4": { "class": `flex-grow` }, "5": { "class": `flex flex-center-y` }, "6": { "class": `flex flex-center gap-5 mr-10` }, "7": { "class": `bg-h-528909 pill w-16 h-16 outline-none cursor-pointer b-transparent`, "click": toggleGreen }, "8": { "class": `bg-h-0077b6 pill w-16 h-16 outline-none cursor-pointer b-transparent`, "click": toggleBlue }, "9": { "class": `bg-h-890934 pill w-16 h-16 outline-none cursor-pointer b-transparent`, "click": togglePink }, "10": { "class": `bg-h-710989 pill w-16 h-16 outline-none cursor-pointer b-transparent`, "click": toggleViolet }, "11": { "class": `bg-h-893c09 pill w-16 h-16 outline-none cursor-pointer b-transparent mr-5`, "click": toggleBrown }, "12": { "class": `fa-solid fa-sun flex flex-center bg-white pill w-28 h-28 cursor-pointer tx-black`, "id": `modeIcon`, "click": toggleMode }, "13": { "class": `tx-white`, "href": `/temple/docs/index.html` }, "14": { "class": `tx-t-1 tx-5xl ml-10`, "href": `https://github.com/OSSPhilippines/temple`, "target": `_blank` }, "15": { "class": `fab fa-github` }, "16": { "class": `bg-h-cb3837 pill tx-t-1 tx-lg ml-5 p-5 tx-center`, "href": `https://www.npmjs.com/package/@ossph/temple`, "target": `_blank` }, "17": { "class": `fab fa-npm text-white` }, "18": { "class": `bg-h-7289da pill tx-t-1 tx-lg ml-5 p-5 tx-center`, "href": `https://discord.gg/open-source-software-ph-905496362982981723`, "target": `_blank` }, "19": { "class": `fab fa-discord text-white` }, "20": { "left": true }, "21": { "class": `flex flex-center-y bg-t-2 py-15 pr-5 pl-10` }, "22": { "href": `/temple` }, "23": { "class": `h-26 mr-10`, "src": `/temple/temple-icon.png`, "alt": `Temple Logo` }, "24": { "class": `flex-grow m-0 tx-upper` }, "25": { "class": `tx-white`, "href": `/temple` }, "26": { "class": `fas fa-fw fa-chevron-left cursor-pointer none md-inline-block`, "click": toggle }, "27": { "class": `bg-t-1 scroll-auto h-calc-full-60` }, "28": { "class": `bt-1 bt-solid bt-t-1 tx-muted tx-14 mb-0 mt-0 pt-20 pb-10 pl-10 tx-upper` }, "29": { "class": `block tx-t-1 py-10 pl-10 tx-bold`, "href": `/temple/docs/index.html` }, "30": { "class": `block tx-t-1 py-10 pl-10`, "href": `/temple/docs/getting-started.html` }, "31": { "class": `bt-1 bt-solid bt-t-1 tx-muted tx-14 mb-0 mt-20 pt-20 pb-10 pl-10 tx-upper` }, "32": { "class": `block tx-t-1 py-10 pl-10`, "href": `/temple/docs/markup-syntax.html` }, "33": { "class": `block tx-t-1 py-10 pl-10`, "href": `/temple/docs/state-management.html` }, "34": { "class": `block tx-t-1 py-10 pl-10`, "href": `/temple/docs/component-strategy.html` }, "35": { "class": `block tx-t-1 py-10 pl-10`, "href": `/temple/docs/compiler-api.html` }, "36": { "class": `block tx-t-1 py-10 pl-10`, "href": `/temple/docs/client-api.html` }, "37": { "class": `bt-1 bt-solid bt-t-1 tx-muted tx-14 mb-0 mt-20 pt-20 pb-10 pl-10 tx-upper` }, "38": { "class": `block tx-t-1 py-10 pl-10`, "href": `/temple/docs/template-engine.html` }, "39": { "class": `block tx-t-1 py-10 pl-10`, "href": `/temple/docs/single-page.html` }, "40": { "class": `block tx-t-1 py-10 pl-10`, "href": `/temple/docs/static-site.html` }, "41": { "class": `block tx-t-1 py-10 pl-10`, "href": `/temple/docs/component-publisher.html` }, "42": { "class": `block tx-t-1 py-10 pl-10 mb-100`, "href": `/temple/docs/developer-tools.html` }, "45": { "class": `tx-primary tx-upper tx-30 py-20` }, "46": { "p": true, "trim": true, "class": `tx-lh-36 py-20` }, "47": { "p": true, "trim": true, "class": `tx-lh-36 py-20` }, "48": { "p": true, "trim": true, "class": `tx-lh-36 py-20` }, "49": { "p": true, "trim": true, "class": `tx-lh-36 py-20` }, "50": { "class": `block py-20`, "title": `Basic Example` }, "51": { "class": `flex bg-white lg-block` }, "52": { "numbers": true, "trim": true, "detab": 16, "class": `basis-half` }, "53": { "class": `basis-half` }, "56": { "p": true, "trim": true, "class": `tx-lh-36 py-20` }, "57": { "title": `Transpiler Example`, "class": `py-20` }, "58": { "class": `flex bg-h-EFEFEF h-full lg-block` }, "59": { "class": `basis-half scroll-auto`, "scroll": true, "numbers": true, "ltrim": true, "detab": 16 }, "60": { "class": `basis-half h-full b-t-1 b-solid by-0 bl-1 br-0 lg-bl-0 lg-bt-1 lg-pt-10 lg-h-auto scroll-auto`, "lang": `js`, "trim": true, "scroll": true, "detab": 16 }, "61": { "class": `flex` }, "62": { "class": `flex-grow tx-right tx-primary py-40`, "href": `/temple/docs/getting-started.html` }, "63": { "name": `chevron-right`, "theme": `tx-1` }, "64": { "class": `foot` } };
    ...
    if (!customElements.getName(Icon_39232c264eb9a88ed555)) {
      customElements.define("element-icon", Icon_39232c264eb9a88ed555);
    }
    if (!customElements.getName(Docs_9f0034427a9b6b0642bd)) {
      customElements.define("api-docs", Docs_9f0034427a9b6b0642bd);
    }
  ...
  var components = {
    ...
    "ElementIcon_39232c264eb9a88ed555": Icon_39232c264eb9a88ed555,
    "ApiDocs_9f0034427a9b6b0642bd": Docs_9f0034427a9b6b0642bd,
  ...
  var BUILD_ID = "d20911175ed300bb285a";
